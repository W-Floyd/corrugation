      ...
      <template v-for="(n, index) in locationTree" :key="n.id">
        <li>
          <a
            ...
            :class="[
              'cursor-pointer rounded px-1 text-blue-600 no-underline transition-colors hover:text-blue-700 hover:underline dark:text-sky-400 dark:hover:text-sky-300',
              dragOverId === n.id
